...
angular.module('app.controllers', ['pascalprecht.translate', 'ngCookies'])
  .controller('AppCtrl', ['$rootScope', '$scope', '$translate', '$localStorage', '$sessionStorage', '$window', '$state', 'UserService', 'safeApply','crypt',
    function(              $rootScope,   $scope,   $translate,   $localStorage,   $sessionStorage,   $window,   $state,   UserService, safeApply,crypt) {
  ...
  .controller('ModalInstanceCtrl', ['$scope', '$modalInstance', 'items', function($scope, $modalInstance, items) {
    ...
    .controller('ClassModalInstanceCtrl', ['$scope', '$modalInstance', 'items', function($scope, $modalInstance, items) {
        $scope.column = {};
    ...
    .controller('ColumnDeleteModalInstanceCtrl', ['$scope', '$modalInstance', 'items', function($scope, $modalInstance, items) {
        $scope.items = items;
    ...
    //databrowser add column modal
    .controller('ColumnModalInstanceCtrl', ['$scope', '$modalInstance', 'items', function($scope, $modalInstance, items) {
        $scope.items = items;
  ...
  .controller('SignupFormController', ['$scope', '$http', '$state', 'UserService', '$localStorage',
   ...
   // project controller
  .controller('ProjectFormController', ['$rootScope', '$scope', '$window', '$http', '$state',
